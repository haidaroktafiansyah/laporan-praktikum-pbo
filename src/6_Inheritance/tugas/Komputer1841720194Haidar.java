 ...
 * @author Haidar
 */
public class Komputer1841720194Haidar {
    ...
    public Komputer1841720194Haidar() {
    }

    public Komputer1841720194Haidar(String mMerk, int mKecProsesor, int mSizeMemory, String mJnsProsesor) {
        this.mMerk = mMerk;
